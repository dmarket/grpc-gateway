...
gulp.task('server', shell.task([
  'go build -o bin/example-server github.com/dmarket/grpc-gateway/examples/cmd/example-grpc-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw github.com/dmarket/grpc-gateway/examples/cmd/example-gateway-server',
]));
