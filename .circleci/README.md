...
```bash
$ docker run -v $(pwd):/go/src/github.com/dmarket/grpc-gateway --rm jfbrandhorst/grpc-gateway-build-env:1.12 \
    /bin/bash -c 'cd /go/src/github.com/dmarket/grpc-gateway && \
        make realclean && \
